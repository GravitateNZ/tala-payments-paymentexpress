...
use Tala\Payments\PaymentExpressPxPost\Response;
...
class ResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('\Tala\Payments\Exception\InvalidResponseException');
    ...
    {
        $this->setExpectedException('\Tala\Payments\PaymentExpressPxPost\Exception', 'Transaction Declined');
